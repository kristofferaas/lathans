...
const loanDetailsSchema = z.object({
  ...
  loanAmount: z.number({ message: "Lånebeløp er påkrevd" }),
  nominalRate: z.number({ message: "Nominell rente er påkrevd" }),
  effectiveRate: z.number({ message: "Effektiv rente er påkrevd" }),
  monthlyPayment: z.number({ message: "Månedlig betaling er påkrevd" }),
  installment: z.number({ message: "Avdrag er påkrevd" }),
  interest: z.number({ message: "Rente er påkrevd" }),
  fees: z.number({ message: "Gebyrer er påkrevd" }),
});

type LoanDetailsFormSchema = z.infer<typeof loanDetailsSchema>;
