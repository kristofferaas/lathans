...
export function Header() {
  ...
  return (
    <>
      <header
        className={cn(
          "bg-background/95 supports-[backdrop-filter]:bg-background/60 fixed top-0 right-0 left-0 z-50 h-16 py-4 pr-2 pl-4 backdrop-blur transition-transform duration-300 ease-in-out md:h-20 md:px-8 md:py-6",
